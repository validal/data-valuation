...
class KNNShapley(DataEvaluator, ModelLessMixin):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"KNNShapley(k_neighbors={self.k_neighbors}, batch_size={self.batch_size}, "
            f"embedding_model={embedding_str}, debug={self.debug})"
        )
    ...
    def train_data_values(self, *args, **kwargs):
        ...
        for j in progress_range(m, "KNN-Shapley (per valid point)"):
